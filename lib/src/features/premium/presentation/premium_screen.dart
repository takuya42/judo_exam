        ...
        body: const Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              Text('購入済み', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
              SizedBox(height: 6),
              Text('買い切り版を利用中です'),
            ],
          ),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(premium.product?.price ?? '1,500円（税込）', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.w900, color: const Color(0xFF006C52))),
                  ...
                  FilledButton.icon(
                    onPressed: premium.isBusy ? null : () => ref.read(premiumControllerProvider.notifier).purchase(),
                    icon: const Icon(Icons.lock_open_rounded),
                    label: const Text('買い切り版を購入'),
                  ),
                  TextButton(
                    onPressed: premium.isBusy ? null : () => ref.read(premiumControllerProvider.notifier).restore(),
